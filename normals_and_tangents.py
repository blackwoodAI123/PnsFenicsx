...
def facet_vector_approximation(V: dfx.fem.FunctionSpace,
    ...
    if V.mesh.geometry.dim == 1:
        nh_norm_vec = (nh[0]/cond_norm)
    elif V.mesh.geometry.dim == 2:
        nh_norm_vec = (nh[0]/cond_norm, nh[1]/cond_norm)
    elif V.mesh.geometry.dim == 3:
        nh_norm_vec = (nh[0]/cond_norm, nh[1]/cond_norm, nh[2]/cond_norm)
    
    V0, V1, V2 = V.sub(0), V.sub(1), V.sub(2)
    V0_c, V1_c, V2_c = V0.collapse()[0], V1.collapse()[0], V2.collapse()[0]
    n0_norm_vec, n1_norm_vec, n2_norm_vec = nh_norm_vec[0], nh_norm_vec[1], nh_norm_vec[2]
    n0_norm, n1_norm, n2_norm = dfx.fem.Expression(n0_norm_vec, V0_c.element.interpolation_points), dfx.fem.Expression(n1_norm_vec, V1_c.element.interpolation_points), dfx.fem.Expression(n2_norm_vec, V2_c.element.interpolation_points)
    n0_out, n1_out, n2_out = dfx.fem.Function(V0_c), dfx.fem.Function(V1_c), dfx.fem.Function(V2_c)
    n0_out.interpolate(n0_norm)
    n1_out.interpolate(n1_norm)
    n2_out.interpolate(n2_norm)
    return n0_out, n1_out, n2_out
